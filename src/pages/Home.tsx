              ...
              <div className="relative w-full max-w-3xl overflow-hidden rounded-2xl border border-brand-cyan/25 bg-[linear-gradient(120deg,rgba(0,194,224,0.10),rgba(0,194,224,0.04))] pl-6 pr-5 sm:px-10 py-1.5 sm:py-6 elev-soft">
                ...
                <div className="flex flex-col divide-y divide-brand-cyan/15 sm:flex-row sm:items-center sm:justify-center sm:divide-y-0 sm:divide-x sm:divide-brand-cyan/20">
                  {[
                    ...
                    <div
                      key={stat.value}
                      className="flex items-baseline justify-between gap-4 py-3.5 sm:flex-col sm:items-center sm:justify-center sm:gap-0 sm:py-0 sm:px-6 lg:px-10"
                    >
                      <div className="text-xl sm:text-2xl font-black tracking-tight text-brand-navy whitespace-nowrap">{stat.value}</div>
                      <div className="text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.1em] sm:tracking-[0.15em] text-zinc-500 sm:mt-1 whitespace-nowrap">{stat.label}</div>
                    </div>
                  ))}
                </div>
              </div>
